...
GBK 亦采用双字节表示，总体编码范围为 8140-FEFE 之间，首字节在 81-FE 之间，尾字节在 40-FE 之间，剔除 XX7F 一条线。
	 ...
	 * @return
	 */
	public static String cutStrUtf8(String orignal, int count, String more) {
		try {
			String str = cutStrUtf8(orignal, count);
	 ...
	 */
	public static String cutStrUtf8(String orignal, int count) throws UnsupportedEncodingException {
		// 原始字符不为null，也不是空字符串
	...
	public static void main(String[] args) {
		System.out.println(StringUtil.formatFenMoney("2000"));
	}
