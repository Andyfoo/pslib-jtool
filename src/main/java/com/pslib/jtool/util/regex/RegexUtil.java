package com.pslib.jtool.util.regex;
...
public class RegexUtil {
	public static void main(String[] args) {
		System.out.println(JSONUtil.toJsonPrettyStr(getMatchArray("aaaabb=123bccc", "([\\d]+)")));
		
		System.out.println(JSONUtil.toJsonPrettyStr(RegexUtil.getMatchArray("A – B", "([^\\-]+) [\\-–]+ (.*)")));
